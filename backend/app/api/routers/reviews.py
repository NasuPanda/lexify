...
from app.services.confidence_level_service import create_confidence_level, get_confidence_level_by_id, update_confidence_level, delete_confidence_level
...
async def get_confidence_level_endpoint(
    ...
    confidence_level = get_confidence_level_by_id(db, confidence_id, current_user.id)
...
async def update_confidence_level_endpoint(
    ...
    updated_confidence_level = update_confidence_level(db, confidence_id, current_user.id, confidence_data)
...
async def delete_confidence_level_endpoint(
    ...
    is_success = delete_confidence_level(db, confidence_id, current_user.id)
    if not is_success:
